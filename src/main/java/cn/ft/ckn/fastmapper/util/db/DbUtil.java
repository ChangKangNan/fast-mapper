...
import cn.ft.ckn.fastmapper.bean.db.ColumnInfo;
import cn.ft.ckn.fastmapper.bean.config.GenerateConfig;
import cn.ft.ckn.fastmapper.bean.db.TableInfo;
...
public class DbUtil {
     ...
     * @param tableInfo 表信息
     */
    public void setPackPath(GenerateConfig conf, TableInfo tableInfo) {
     ...
     */
    public Connection getConnection(GenerateConfig fileConfig) throws ClassNotFoundException {
