...
public class SelectCriteria<T,R> {
    ...
    public R in(Object... value) {
        ...
        SearchParam.get().getWhereCondition().add(new SearchParam.WhereCondition(this.fieldName, wrap, Expression.In.expression, SearchParam.get().isAnd));
        init();
        return returnObj;
    }
    ...
    public R asc() {
        SearchParam.get().getOrderByCondition().add(new SearchParam.OrderByCondition(this.fieldName, " ASC "));
        return returnObj;
    }

    public R desc() {
        SearchParam.get().getOrderByCondition().add(new SearchParam.OrderByCondition(this.fieldName, " DESC "));
        return returnObj;
    }
