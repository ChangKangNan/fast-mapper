...
public static class InsertMapper extends InsertDao<BankPaper, InsertMapper> {
        ...
        super(FastMapperParam,BankPaper.class, InsertMapper.class);
        }
}
...
public static class BaseSelectMapper extends BaseSelectAction<BankPaper, BaseSelectMapper> {
        ...
        super(FastMapperParam,BankPaper.class, BaseSelectMapper.class);
        }


        public SelectCriteria<BankPaper, BaseSelectMapper> id() {
        this.fieldName="id";
        return new SelectCriteria<>(this.FastMapperParam, this.fieldName,BankPaper.class, BaseSelectMapper.class);
        }
...
public static class BaseUpdateMapper extends BaseUpdateAction<BankPaper, BaseUpdateMapper> {
        ...
        public BaseUpdateMapper(FastMapperParam FastMapperParam) {
            super(FastMapperParam,BankPaper.class, BaseUpdateMapper.class);
        }

        public UpdateCriteria<BankPaper, BaseUpdateMapper> id() {
        this.fieldName="id";
        return new UpdateCriteria<>(this.FastMapperParam,this.fieldName,BankPaper.class, BaseUpdateMapper.class);
        }
...
public static class BaseDeletedMapper extends BaseDeletedAction<BankPaper, BaseDeletedMapper> {
        ...
        super(FastMapperParam,BankPaper.class, BaseDeletedMapper.class);
        }


        public DeletedCriteria<BankPaper, BaseDeletedMapper> id() {
        this.fieldName="id";
        return new DeletedCriteria<>(this.FastMapperParam,this.fieldName,BankPaper.class, BaseDeletedMapper.class);
        }
