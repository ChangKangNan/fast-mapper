...
public static class InsertMapper extends InsertDao<PayInterestDetail, InsertMapper> {
        ...
        super(splicingParam,PayInterestDetail.class, InsertMapper.class);
        }
}
...
public static class BaseSelectMapper extends BaseSelectAction<PayInterestDetail, BaseSelectMapper> {
        ...
        super(splicingParam,PayInterestDetail.class, BaseSelectMapper.class);
        }


        public SelectCriteria<PayInterestDetail, BaseSelectMapper> id() {
        this.fieldName="id";
        return new SelectCriteria<>(this.splicingParam, this.fieldName,PayInterestDetail.class, BaseSelectMapper.class);
        }
...
public static class BaseUpdateMapper extends BaseUpdateAction<PayInterestDetail, BaseUpdateMapper> {
        ...
        public BaseUpdateMapper(SplicingParam splicingParam) {
            super(splicingParam,PayInterestDetail.class, BaseUpdateMapper.class);
        }

        public UpdateCriteria<PayInterestDetail, BaseUpdateMapper> id() {
        this.fieldName="id";
        return new UpdateCriteria<>(this.splicingParam,this.fieldName,PayInterestDetail.class, BaseUpdateMapper.class);
        }
...
public static class BaseDeletedMapper extends BaseDeletedAction<PayInterestDetail, BaseDeletedMapper> {
        ...
        super(splicingParam,PayInterestDetail.class, BaseDeletedMapper.class);
        }


        public DeletedCriteria<PayInterestDetail, BaseDeletedMapper> id() {
        this.fieldName="id";
        return new DeletedCriteria<>(this.splicingParam,this.fieldName,PayInterestDetail.class, BaseDeletedMapper.class);
        }
