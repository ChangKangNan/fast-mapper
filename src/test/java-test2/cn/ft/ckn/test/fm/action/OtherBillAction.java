...
public static class InsertMapper extends InsertDao<OtherBill, InsertMapper> {
        ...
        super(FastMapperParam,OtherBill.class, InsertMapper.class);
        }
}
...
public static class BaseSelectMapper extends BaseSelectAction<OtherBill, BaseSelectMapper> {
        ...
        super(FastMapperParam,OtherBill.class, BaseSelectMapper.class);
        }


        public SelectCriteria<OtherBill, BaseSelectMapper> id() {
        this.fieldName="id";
        return new SelectCriteria<>(this.FastMapperParam, this.fieldName,OtherBill.class, BaseSelectMapper.class);
        }
...
public static class BaseUpdateMapper extends BaseUpdateAction<OtherBill, BaseUpdateMapper> {
        ...
        public BaseUpdateMapper(FastMapperParam FastMapperParam) {
            super(FastMapperParam,OtherBill.class, BaseUpdateMapper.class);
        }

        public UpdateCriteria<OtherBill, BaseUpdateMapper> id() {
        this.fieldName="id";
        return new UpdateCriteria<>(this.FastMapperParam,this.fieldName,OtherBill.class, BaseUpdateMapper.class);
        }
...
public static class BaseDeletedMapper extends BaseDeletedAction<OtherBill, BaseDeletedMapper> {
        ...
        super(FastMapperParam,OtherBill.class, BaseDeletedMapper.class);
        }


        public DeletedCriteria<OtherBill, BaseDeletedMapper> id() {
        this.fieldName="id";
        return new DeletedCriteria<>(this.FastMapperParam,this.fieldName,OtherBill.class, BaseDeletedMapper.class);
        }
