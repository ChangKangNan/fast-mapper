...
public static class InsertMapper extends InsertDao<OpenBill, InsertMapper> {
        ...
        super(FastMapperParam,OpenBill.class, InsertMapper.class);
        }
}
...
public static class BaseSelectMapper extends BaseSelectAction<OpenBill, BaseSelectMapper> {
        ...
        super(FastMapperParam,OpenBill.class, BaseSelectMapper.class);
        }


        public SelectCriteria<OpenBill, BaseSelectMapper> id() {
        this.fieldName="id";
        return new SelectCriteria<>(this.FastMapperParam, this.fieldName,OpenBill.class, BaseSelectMapper.class);
        }
...
public static class BaseUpdateMapper extends BaseUpdateAction<OpenBill, BaseUpdateMapper> {
        ...
        public BaseUpdateMapper(FastMapperParam FastMapperParam) {
            super(FastMapperParam,OpenBill.class, BaseUpdateMapper.class);
        }

        public UpdateCriteria<OpenBill, BaseUpdateMapper> id() {
        this.fieldName="id";
        return new UpdateCriteria<>(this.FastMapperParam,this.fieldName,OpenBill.class, BaseUpdateMapper.class);
        }
...
public static class BaseDeletedMapper extends BaseDeletedAction<OpenBill, BaseDeletedMapper> {
        ...
        super(FastMapperParam,OpenBill.class, BaseDeletedMapper.class);
        }


        public DeletedCriteria<OpenBill, BaseDeletedMapper> id() {
        this.fieldName="id";
        return new DeletedCriteria<>(this.FastMapperParam,this.fieldName,OpenBill.class, BaseDeletedMapper.class);
        }
