...
public static class InsertMapper extends InsertDao<BankPaperOpen, InsertMapper> {
        ...
        super(FastMapperParam,BankPaperOpen.class, InsertMapper.class);
        }
}
...
public static class BaseSelectMapper extends BaseSelectAction<BankPaperOpen, BaseSelectMapper> {
        ...
        super(FastMapperParam,BankPaperOpen.class, BaseSelectMapper.class);
        }


        public SelectCriteria<BankPaperOpen, BaseSelectMapper> id() {
        this.fieldName="id";
        return new SelectCriteria<>(this.FastMapperParam, this.fieldName,BankPaperOpen.class, BaseSelectMapper.class);
        }
...
public static class BaseUpdateMapper extends BaseUpdateAction<BankPaperOpen, BaseUpdateMapper> {
        ...
        public BaseUpdateMapper(FastMapperParam FastMapperParam) {
            super(FastMapperParam,BankPaperOpen.class, BaseUpdateMapper.class);
        }

        public UpdateCriteria<BankPaperOpen, BaseUpdateMapper> id() {
        this.fieldName="id";
        return new UpdateCriteria<>(this.FastMapperParam,this.fieldName,BankPaperOpen.class, BaseUpdateMapper.class);
        }
...
public static class BaseDeletedMapper extends BaseDeletedAction<BankPaperOpen, BaseDeletedMapper> {
        ...
        super(FastMapperParam,BankPaperOpen.class, BaseDeletedMapper.class);
        }


        public DeletedCriteria<BankPaperOpen, BaseDeletedMapper> id() {
        this.fieldName="id";
        return new DeletedCriteria<>(this.FastMapperParam,this.fieldName,BankPaperOpen.class, BaseDeletedMapper.class);
        }
