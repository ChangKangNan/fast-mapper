...
public static class InsertMapper extends InsertDao<BankPaperApply, InsertMapper> {
        ...
        super(FastMapperParam,BankPaperApply.class, InsertMapper.class);
        }
}
...
public static class BaseSelectMapper extends BaseSelectAction<BankPaperApply, BaseSelectMapper> {
        ...
        super(FastMapperParam,BankPaperApply.class, BaseSelectMapper.class);
        }


        public SelectCriteria<BankPaperApply, BaseSelectMapper> id() {
        this.fieldName="id";
        return new SelectCriteria<>(this.FastMapperParam, this.fieldName,BankPaperApply.class, BaseSelectMapper.class);
        }
...
public static class BaseUpdateMapper extends BaseUpdateAction<BankPaperApply, BaseUpdateMapper> {
        ...
        public BaseUpdateMapper(FastMapperParam FastMapperParam) {
            super(FastMapperParam,BankPaperApply.class, BaseUpdateMapper.class);
        }

        public UpdateCriteria<BankPaperApply, BaseUpdateMapper> id() {
        this.fieldName="id";
        return new UpdateCriteria<>(this.FastMapperParam,this.fieldName,BankPaperApply.class, BaseUpdateMapper.class);
        }
...
public static class BaseDeletedMapper extends BaseDeletedAction<BankPaperApply, BaseDeletedMapper> {
        ...
        super(FastMapperParam,BankPaperApply.class, BaseDeletedMapper.class);
        }


        public DeletedCriteria<BankPaperApply, BaseDeletedMapper> id() {
        this.fieldName="id";
        return new DeletedCriteria<>(this.FastMapperParam,this.fieldName,BankPaperApply.class, BaseDeletedMapper.class);
        }
