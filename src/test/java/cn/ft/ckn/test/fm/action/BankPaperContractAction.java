...
public static class InsertMapper extends InsertDao<BankPaperContract, InsertMapper> {
        ...
        super(splicingParam,BankPaperContract.class, InsertMapper.class);
        }
}
...
public static class BaseSelectMapper extends BaseSelectAction<BankPaperContract, BaseSelectMapper> {
        ...
        super(splicingParam,BankPaperContract.class, BaseSelectMapper.class);
        }


        public SelectCriteria<BankPaperContract, BaseSelectMapper> id() {
        this.fieldName="id";
        return new SelectCriteria<>(this.splicingParam, this.fieldName,BankPaperContract.class, BaseSelectMapper.class);
        }
...
public static class BaseUpdateMapper extends BaseUpdateAction<BankPaperContract, BaseUpdateMapper> {
        ...
        public BaseUpdateMapper(SplicingParam splicingParam) {
            super(splicingParam,BankPaperContract.class, BaseUpdateMapper.class);
        }

        public UpdateCriteria<BankPaperContract, BaseUpdateMapper> id() {
        this.fieldName="id";
        return new UpdateCriteria<>(this.splicingParam,this.fieldName,BankPaperContract.class, BaseUpdateMapper.class);
        }
...
public static class BaseDeletedMapper extends BaseDeletedAction<BankPaperContract, BaseDeletedMapper> {
        ...
        super(splicingParam,BankPaperContract.class, BaseDeletedMapper.class);
        }


        public DeletedCriteria<BankPaperContract, BaseDeletedMapper> id() {
        this.fieldName="id";
        return new DeletedCriteria<>(this.splicingParam,this.fieldName,BankPaperContract.class, BaseDeletedMapper.class);
        }
