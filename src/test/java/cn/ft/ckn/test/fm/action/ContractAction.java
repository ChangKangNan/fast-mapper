...
public static class InsertMapper extends InsertDao<Contract, InsertMapper> {
        ...
        super(splicingParam,Contract.class, InsertMapper.class);
        }
}
...
public static class BaseSelectMapper extends BaseSelectAction<Contract, BaseSelectMapper> {
        ...
        super(splicingParam,Contract.class, BaseSelectMapper.class);
        }


        public SelectCriteria<Contract, BaseSelectMapper> id() {
        this.fieldName="id";
        return new SelectCriteria<>(this.splicingParam, this.fieldName,Contract.class, BaseSelectMapper.class);
        }
...
public static class BaseUpdateMapper extends BaseUpdateAction<Contract, BaseUpdateMapper> {
        ...
        public BaseUpdateMapper(SplicingParam splicingParam) {
            super(splicingParam,Contract.class, BaseUpdateMapper.class);
        }

        public UpdateCriteria<Contract, BaseUpdateMapper> id() {
        this.fieldName="id";
        return new UpdateCriteria<>(this.splicingParam,this.fieldName,Contract.class, BaseUpdateMapper.class);
        }
...
public static class BaseDeletedMapper extends BaseDeletedAction<Contract, BaseDeletedMapper> {
        ...
        super(splicingParam,Contract.class, BaseDeletedMapper.class);
        }


        public DeletedCriteria<Contract, BaseDeletedMapper> id() {
        this.fieldName="id";
        return new DeletedCriteria<>(this.splicingParam,this.fieldName,Contract.class, BaseDeletedMapper.class);
        }
